...
// Copyright (c) 2013 The JinBaoCoin developers
...
uint256 hashGenesisBlock("0x00000b591b8c33b95cdcaf1a29afd4bbd1db15d59e93ee12b8cd494a345da20c");
static const unsigned int timeGenesisBlock = 1467290959;
...
const string strMessageMagic = "JinBaoCoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
       const char* pszTimestamp = "already in already databases we JinBaoCoinpark from USA with Transactions.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xd3d76f81d388a8bf7517d00a51b188046b97dbd87575204aaa66e9335169dc6c"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("JinBaoCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("JinBaoCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("JinBaoCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("JinBaoCoin-miner");
    ...
    try { loop {
        ...
        printf("Running JinBaoCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("JinBaoCoinMiner terminated\n");
        throw;
    }
}
